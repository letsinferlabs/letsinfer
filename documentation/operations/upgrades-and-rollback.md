...
distinct installed placement-group release. Exact replicas are deduplicated;
mixed target-specific or temporarily mixed-version placement groups remain separate.
